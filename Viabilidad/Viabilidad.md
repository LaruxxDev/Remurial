# Estimación de Recursos y Costes (Fase 1: Hospital)
Tiempo total: 3 meses

| Concepto | Detalle | Coste Real | Coste Planteable |
| ---- | --- | --- | --- |
...
*Tras observar los beneficios habría que decidir si se reinvierten en la empresa o cada uno se lleva su parte.
...
>
>Entonces, si tenemos un pago de 5€:
>- IVA = 1.00€
>- tarifa fija = 0.30€
>- 2.9% = 0.15€
>- Eso es 1.45€, por lo que recibirás 3.55€ antes de la conversión. (obtienes el >71%)
>
>Sin embargo, si tenemos un pago de 500€:
>
>- IVA = 100.00€
>- tarifa fija = 0.30€
>- 2.9% = 14.50€
...
* **Itch.io:** Coste 0€ (Gratis). La plataforma se lleva un porcentaje opcional de las ventas (por defecto 10% pero se puede reducir a 0). Es ideal para prototipos y ganar comunidad.
* **Steam (Steam Direct):** €100 USD (84,99€ - [Steamdirect Tarifa de publicación](https://store.steampowered.com/sub/163632/?l=spanish)) por juego. Este pago se recupera si el juego alcanza los €1,000 en ventas.
